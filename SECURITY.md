...
This document explains how to report security vulnerabilities and helps keep **MarketPilot** safe for all users.  
...
If you discover a security issue in MarketPilot, please **do not** post it publicly.  
...
To deploy MarketPilot securely:
